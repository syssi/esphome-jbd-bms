...
// Synthetic frame: cells 1 and 3 balancing. Decoded key values:
//   balancer_status_bitmask: 0x00000005 → bits 0,2 → cells 1, 3
//   errors_bitmask: 0
static const std::vector<uint8_t> HWINFO_FRAME_BALANCING_CELLS_1_3 = {
    0x06, 0x18, 0x00, 0x00, 0x01, 0xF2, 0x01, 0xF4, 0x00, 0x00, 0x2C, 0x7C, 0x00, 0x00, 0x00,
    0x05, 0x00, 0x00, 0x80, 0x64, 0x03, 0x04, 0x03, 0x0B, 0x8B, 0x0B, 0x8A, 0x0B, 0x84,
};
